...
\begin{figure}
	...
	\captionsetup{justification=centering}
	\caption{Storage of edges having single cardinality edge label STUDYAT and WORKAT as special property of PERSON. \hspace{\textwidth} Properties of these edges are also stored in vertex columns of PERSON.}
